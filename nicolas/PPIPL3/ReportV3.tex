...
in a precision of $0.9285$ and a recall of $0.7420$. Same analyses
...
The precision when using the count of paths of length 3 (A3) is $0.8587$
while the recall is $0.7685$. It is interesting to observe that precision
decreased $7.5\%$ when compared to the previous case, but recall
increased $3.6\%$. A similar situation is obtained for the model
with the normalized score (L3), whose precision decreased to $0.8936$
($-3.8\%$) and recall increased to $0.7610$ ($+2.6\%$). It can
